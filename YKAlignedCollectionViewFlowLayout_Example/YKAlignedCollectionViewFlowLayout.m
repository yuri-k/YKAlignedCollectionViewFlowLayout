...
- (NSArray *)layoutAttributesForElementsInRect:(CGRect)rect {
    ...
    NSMutableDictionary *rowsDictionary;
    
    rowsDictionary = [[self rowsWithCellsDictionaryForAttributes:layoutAttributes] mutableCopy];
...
- (UIEdgeInsets)centerInsetWithAttributes:(NSArray *)layoutAttributes {
    ...
    if ([self heightOfCellsContentWithAttributes:layoutAttributes] > CGRectGetHeight(self.collectionView.frame) ||
        layoutAttributes.count == 0) {
        return UIEdgeInsetsZero;
    } else {
